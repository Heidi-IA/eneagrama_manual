...
from app import build_pdf_from_payload as build_integral_pdf
from app import build_bonus_estructura_pensamiento
from app import ENEATIPO_TEXTOS as ENEATIPO_INTEGRAL
